      ...
      <div class="container">
        <div class="row header-desk">
          <div class="col-md-2 col-sm-3 col-xs-12 logo">
            <?php if ($logo) { ?>
              <a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" width="119" height="auto" /></a>
            <?php } else { ?>
          ...
          <div class="col-md-5 col-sm-12 col-xs-12 data-info">
            <div class="row">
              <div class="col-md-5 col-sm-5 col-xs-5 data">
                <p><?php echo $open; ?></p>
              </div>
              <div class="col-md-7 col-sm-7 col-xs-7 phone">
